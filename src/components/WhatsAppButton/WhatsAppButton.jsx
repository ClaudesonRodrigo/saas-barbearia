...
// Ícone do WhatsApp em SVG para não dependermos de bibliotecas externas
const WhatsAppIcon = () => (
...
const WhatsAppButton = ({ phoneNumber, message }) => {
  // Se a barbearia não tiver um telefone cadastrado, o botão não aparece.
  if (!phoneNumber) {
    return null;
  }

  // Limpa o número de telefone de caracteres não numéricos (parênteses, traços, etc.)
